...
parallel --verbose slim -d N={1} -d L=1 -d teJumpP=0.01 -d teDeathRate={2} -d simTime=2000 -d replicate={3} TE_diploid_selfing_WIAS.slim ::: 5000 50000 500000 ::: 0.001 0.0005 0.0001 ::: $(seq 10)
